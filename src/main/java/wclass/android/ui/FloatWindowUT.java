...
public class FloatWindowUT {
    ...
    public static WindowManager.LayoutParams makeDefaultLeftTopParams() {
    ...
    public static WindowManager.LayoutParams makeDefaultLeftTopParams_NoTouch() {
        WindowManager.LayoutParams p = leftTopParams();
